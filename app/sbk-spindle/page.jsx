...
const images = [
  { src: '/img/Drum-Red-(2).png', label: 'SBK SPINDLE OIL - pail' },
  { src: '/img/Drum-Red-(2).png', label: 'SBK SPINDLE OIL drum' },
  { src: '/img/Drum-Red-(2).png', label: 'SBK SPINDLE OIL IBC' },
];

export default function SbkSpindlePage() {
  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(3, 7, 18, 0.95) 30%, rgba(3, 7, 18, 0.6) 70%, rgba(3, 7, 18, 0.4) 100%), url('/productbanner/textile.jpg')",
        }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          <nav className="flex items-center space-x-2 text-xs md:text-sm text-slate-400 mb-6 scroll-reveal delay-100">
            ...
            <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
            <Link href="/spindle-oil" className="hover:text-white transition">TEXTILE OIL</Link>
            <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-4 scroll-reveal reveal-left">
            <div className="bg-slate-50 rounded-2xl p-8 border border-gray-100 flex items-center justify-center min-h-[380px] shadow-sm relative overflow-hidden group">
              <div className="text-center w-full h-full flex flex-col items-center justify-center">
                ...
                />
                <p className="text-slate-500 font-medium text-lg">SBK SPINDLE OIL</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/97167447843?text=Hello,%20I%20would%20like%20to%20inquire%20about%20SPINDLE%20OIL"
                target="_blank"
              ...
              <table className="w-full text-left border-collapse bg-white text-sm min-w-[500px]">
                ...
                <tbody className="divide-y divide-gray-100 text-slate-600">
                  ...
                  {[
                    ...
                    ['KV @ 40\u00b0C', 'ASTM D445', '10', '15', '22.3'],
                    ['KV @ 100\u00b0C', 'ASTM D445', '2.7', '2.4', '4.3'],
                    ['Viscosity Index', 'ASTM D2270', '\u2265 90', '\u2265 95', '\u2265 95'],
                    ['Density @ 15\u00b0C', 'ASTM D4052', '0.8383', '0.8449', '0.8349'],
                    ['Flash Point (\u00b0C)', 'ASTM D92', '\u2265 135', '\u2265 170', '\u2265 200'],
                    ['Pour Point (\u00b0C)', 'ASTM D97', '-27', '-21', '-18'],
                  ].map(([param, method, v1, v2, v3]) => (
                    <tr key={param} className="hover:bg-slate-50/50">
                      ...
                      <td className="px-3 py-3 text-center font-mono">{v1}</td>
                      <td className="px-3 py-3 text-center font-mono">{v2}</td>
                      <td className="px-3 py-3 text-center font-mono">{v3}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
