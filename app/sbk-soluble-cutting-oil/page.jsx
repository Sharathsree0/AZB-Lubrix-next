                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                    ...
                    <div className="max-w-4xl space-y-4">
                        <h1 className="text-white font-serif text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-tight md:leading-none scroll-reveal delay-300">
                            SBK SOLUBLE CUTTING OIL     <br className="hidden md:block" />
                            <span></span>
                        </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SBK SOLUBLE CUTTING OIL</h2>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
                            <a href="https://wa.me/97167447843?text=Hello,%20I%20would%20like%20to%20inquire%20about%20SBK%20soluble%20cutting%20OIL" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-brand-blue hover:bg-opacity-90 text-white font-medium rounded-lg shadow-md transition duration-200 text-sm flex items-center gap-2">
                    ...
                    <div className="space-y-6 scroll-reveal">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-slate-600 text-sm"><strong>Excellent cooling and lubricating properties</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Forms stable milky emulsion with water</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Extends cutting tool life</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Improves surface finish</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                            ...
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Good emulsion stability in hard and soft water</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Suitable for light to medium-duty machining applications</strong></span>
                            </li>
                        </ul>
                        ...
                        <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
                            ...
                            <p className="text-slate-600 text-sm leading-relaxed">
                                SBK Soluble Cutting Oil is recommended for turning, milling, drilling, grinding, reaming, tapping, sawing, and CNC machining operations. The product is suitable for use on a wide range of ferrous and non-ferrous metals including steel, cast iron, aluminum, copper, and brass alloys, providing excellent cooling, lubrication, and corrosion protection during machining processes. Always add AZB ENERGY Soluble Cutting Oil slowly into water while stirring continuously. Never add water directly into the oil concentrate.
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-50 p-4 rounded-xl border border-gray-200">
                            ...
                            <ul className="text-slate-600 text-sm space-y-1 list-disc pl-4">
                                <li>General Metalworking Fluid Applications</li>
                                <li>Grinding, Turning, Milling, and Drilling Applications</li>
                                <li>Automatic and semi-automatic machines</li>
                                <li>Automotive and industrial component machining applications</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="overflow-hidden border border-gray-200 rounded-xl shadow-sm">
                            <table className="w-full text-left border-collapse bg-white text-sm">
                                ...
                                <tbody className="divide-y divide-gray-100 text-slate-600">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Emulsion Stability</td>
                                        <td className="px-4 py-3 text-slate-400">Visual</td>
                                        <td className="px-4 py-3 text-right font-mono">Stable Emulsion</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">KV @ 40°C</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D445</td>
                                        <td className="px-4 py-3 text-right font-mono">32</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Density @ 15°C</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D4052</td>
                                        <td className="px-4 py-3 text-right font-mono">0.8756</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
