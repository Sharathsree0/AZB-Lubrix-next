...
export default function SBKDegreasePro() {
    // Gallery State
    const [mainImage, setMainImage] = useState('/productimage/DEGREASEPRO400ML.png');
    const [mainLabel, setMainLabel] = useState('SBK Degrease Pro');
    ...
    const thumbnails = [
        { src: '/productimage/DEGREASEPRO200ML.png', label: 'SBK Degrease Pro', desc: 'SBK Degrease Pro - 200Ml' },
        { src: '/productimage/DEGREASEPRO400ML.png', label: 'Directions Label', desc: 'SBK Degrease Pro - 400ML' }
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SBK Degrease Pro</h2>
                            <p className="text-xl font-medium text-slate-500 mt-2">Professional Heavy-Duty Degreaser</p>
                        </div>

                        <p className="text-slate-600 leading-relaxed">
                            SBK Degrease Pro is a concentrated, industrial-grade formulation engineered to penetrate deep, dissolve, and instantly break down heavy grease, baked-on oil, stubborn engine sludge, and road grime. Its advanced emulsifying delivery blast cleans thoroughly without leaving behind sticky residues, protecting metal assemblies and maintaining peak mechanical performance.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-3 pt-2">
                            ...
                            <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                                <strong>Category:</strong> Engine &amp; Chassis Maintenance
                            </div>
                            <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                                <strong>Residue:</strong> Clean-Rinse Formula
                            </div>
                            <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                                <strong>Action:</strong> Rapid Penetration &amp; Emulsification
                            </div>
                        </div>

                        {/* Action Buttons */}
                        <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
                            <a href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20SBK%20Degrease" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-brand-blue hover:bg-opacity-90 text-white font-medium rounded-lg shadow-md transition duration-200 text-sm flex items-center gap-2">
                    ...
                    <div className="space-y-6 scroll-reveal">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3 scroll-reveal delay-100">
                                ...
                                <span className="text-slate-600 text-sm"><strong>Deep Penetrating Action:</strong> Rapidly breaks the surface tension of thick, baked-on hydrocarbon deposits and encrusted oils.</span>
                            </li>
                            <li className="flex items-start gap-3 scroll-reveal delay-200">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Emulsifying Formula:</strong> Allows heavy soils to easily blend with water during rinsing, leaving components stripped of contaminants.</span>
                            </li>
                            <li className="flex items-start gap-3 scroll-reveal delay-300">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Multi-Surface Material Compatibility:</strong> Formulated safe for use on steel, iron, and standard heavy-machinery alloy components.</span>
                            </li>
                            <li className="flex items-start gap-3 scroll-reveal delay-400">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Reduces Shop Labor Time:</strong> Fast-acting chemistry cuts down the need for tedious manual scraping and aggressive scrubbing.</span>
                            </li>
                        </ul>
                        ...
                        <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6 scroll-reveal delay-200">
                            ...
                            <p className="text-slate-600 text-sm leading-relaxed">
                                Specially tailored for automotive engines, engine bays, undercarriages, chassis parts, industrial machinery, gears, mechanical linkages, concrete garage floors, and workbenches requiring rigorous grease removal.
                            </p>
                        </div>
                    </div>
                            ...
                            <table className="w-full text-left border-collapse bg-white text-sm">
                                ...
                                <tbody className="divide-y divide-gray-100 text-slate-600">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-4 py-3 text-right font-mono">0.785 – 0.815</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Flash Point, °C</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D93</td>
                                        <td className="px-4 py-3 text-right font-mono">&gt; 40°C</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Solubility in Water</td>
                                        <td className="px-4 py-3 text-slate-400">Internal</td>
                                        <td className="px-4 py-3 text-right font-mono">Emulsifiable</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Cleaning Efficiency</td>
                                        <td className="px-4 py-3 text-slate-400">Internal</td>
                                        <td className="px-4 py-3 text-right font-mono">Excellent</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
