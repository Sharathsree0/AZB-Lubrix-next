...
export default function HydraulicOilHVI() {
    ...
    return (
        <div className="bg-white text-slate-700 antialiased">
            ...
            <section className="relative bg-cover bg-center bg-no-repeat text-white py-16 md:py-18 overflow-hidden w-full" 
                     style={{ backgroundImage: "url('/productbanner/mining.jpg')" }}>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <Link href="#" className="hover:text-green-500 transition">MINING OIL </Link>
                            <span>/</span>
                            <span className="text-green-400">HYDRAULIC OIL HVI</span>
                        </nav>
                        ...
                        <span className="hidden md:inline-block inline-block bg-red-600 text-white text-xs font-bold uppercase tracking-widest px-3 py-1 rounded mb-4 shadow-lg">
                            High Performance MINING OIL
                        </span>
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
                            HYDRAULIC OIL    <span className="text-green-400">HVI</span>
                        </h1>
                        <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
                            Formulated for heavy-duty hydraulic systems operating under extreme temperature variations and high pressures. Delivers high shear stability, superior anti-wear protection, and excellent demulsibility to prevent pump wear, maintain consistent fluid flow, and protect against rust and oxidation in harsh operational environments.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                        ...
                        <main className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                {/* Product 3: SBK Pesado Hydraulic Oil */}
                                <Link href="/products/Mining-oil/hydraulic-oil-hvi/sbk-pesado-hydraulic-oil-hvi" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <span className="absolute top-3 left-3 bg-red-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Mining</span>
                                        <img src="/img/Drum-Red-(2).png" alt="SBK Pesado Hydraulic Oil" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md"/>
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Mining Oil</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">SBK PESADO HYDRAULIC OIL HVI ISO VG</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">High Viscosity Index (HVI) premium hydraulic fluid built for extreme temperature swings, preventing pump wear and maintaining smooth power transfer in heavy extraction equipment.</p>
