...
export default function AirCompressorOilPage() {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
              ...
              <span>/</span>
              <span className="text-green-400">AIR COMPRESSOR OIL</span>
            </nav>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
              AIR COMPRESSOR <span className="text-green-400">OIL</span>
            </h1>
            <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
              Formulated for heavy-duty rotary screw, vane, and reciprocating air compressors. Delivers superior thermal and oxidative stability, high film strength, and rapid water separation to prevent varnish buildup and wear in harsh continuous-duty environments.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
            ...
            <main className="lg:col-span-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {isModalOpen && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4 transition-opacity duration-300">
                    <div className="bg-white rounded-2xl p-6 max-w-xs w-full shadow-2xl border border-gray-100 text-center transform transition-transform duration-300 scale-100">
                      ...
                      <h3 className="text-slate-800 text-base font-extrabold mb-1">
                        Specifications Coming Soon
                      </h3>
                      <p className="text-gray-500 text-xs leading-relaxed mb-5">
                        We're currently updating our product sheet. Complete specifications for this product will be available shortly.
                      </p>
                      <button
                ...
                {/* Product 1: SBK Air Compressor Oil */}
                <a
                  href="#"
                ...
                >
                  <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                    <span className="absolute top-3 left-3 bg-red-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">
                      Mining
                    </span>
                    <img
                      src="/img/Drum-Red-(2).png"
                      alt="SBK Air Compressor Oil"
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">
                      SBK AIR COMPRESSOR OIL
                    </h3>
                    <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">
                      Formulated for heavy-duty mining air compressors, delivering exceptional oxidation stability, minimal carbon deposit formation, and reliable performance under high discharge temperatures.
                    </p>
                    <div className="border-t border-gray-100 pt-4 mt-auto">
                      <div className="w-full py-2 bg-slate-800 text-white text-xs font-bold rounded-lg flex justify-center items-center gap-1.5">
