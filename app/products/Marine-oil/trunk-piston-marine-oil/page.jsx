...
export default function TrunkPistonMarineOil() {
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <Link href="#" className="hover:text-green-500 transition">MARINE OIL </Link>
                            <span>/</span>
                            <span className="text-green-400">TRUNK PISTON MARINE OIL</span>
                        </nav>
                        ...
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
                            TRUNK PISTON MARINE    <span className="text-green-400">OIL</span>
                        </h1>
                        <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
                            Formulated for medium-speed marine trunk piston engines running on heavy fuel oil or MDO. Delivers high Base Number (BN) retention, superior ring-sticking defense, and outstanding soot handling to neutralize acidic combustion byproducts in severe sea conditions.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                        ...
                        <main className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <Link 
                                    href="/products/Marine-oil/trunk-piston-marine-oil/sbk-trunk-piston-marine-oil" 
                                ...
                                >
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <span className="absolute top-3 left-3 bg-red-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Marine</span>
                                        <img src="/img/Drum-Red-(2).png" alt="" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md"/>
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Marine Oil</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">Trunk Piston Marine Oil</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Engineered for medium-speed marine trunk piston engines, delivering high Base Number (BN) retention, acid neutralization, superior deposit control, and robust corrosion protection in harsh sea environments.</p>
