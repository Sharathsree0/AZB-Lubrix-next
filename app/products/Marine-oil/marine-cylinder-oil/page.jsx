...
export default function MarineCylinderOil() {
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <span className="text-green-400">MARINE CYLINDER OIL</span>
                        </nav>
                        ...
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
                           MARINE CYLINDER <span className="text-green-400">OIL</span>
                        </h1>
                        <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
                            Formulated for slow-speed two-stroke marine crosshead engines operating on heavy fuel oil. Delivers superior Base Number (BN) alkalinity to neutralize corrosive acids, preventing liner wear and scuffing under extreme cylinder temperatures and pressures.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                        ...
                        <main className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <Link 
                                    href="/products/Marine-oil/marine-cylinder-oil/sbk-marine-cylinder-oil" 
                                ...
                                >
                                    ...
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">MARINE CYLINDER OIL</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-green-600 transition tracking-tight mb-2 line-clamp-2">MARINE CYLINDER OIL</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Formulated for slow-speed two-stroke marine crosshead engines, offering superior alkalinity to neutralize corrosive acids, prevent liner wear, and protect piston rings under high temperatures.</p>
