...
const thumbnails = [
  { src: '/productimage/1L-gear-oil-sae-140-api-gl-4.png', alt: 'SBK GEAR OIL SAE 140, API GL-4 1L', label: 'SBK GEAR OIL SAE 140, API GL-4 - 1L' },
  { src: '/productimage/4L-gear-oil-sae-140-api-gl-4.png', alt: 'SBK GEAR OIL SAE 140, API GL-4 4L', label: 'SBK GEAR OIL SAE 140, API GL-4 4L' },
  { src: '/productimage/5L-gear-oil-sae-140-api-gl-4.png', alt: 'SBK GEAR OIL SAE 140, API GL-4 5L', label: 'SBK GEAR OIL SAE 140, API GL-4 5L' },
];

export default function SbkGearOilSae140Page() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-4 scroll-reveal reveal-left">
            <div className="bg-slate-50 rounded-2xl p-8 border border-gray-100 flex items-center justify-center min-h-[380px] shadow-sm relative overflow-hidden group">
              ...
              <span className="absolute top-4 left-4 bg-brand-blue text-white font-bold text-[10px] tracking-wider uppercase px-2.5 py-1 rounded">
                High-Quality Mineral-Based Monograde Lubricant
              </span>
            </div>
          ...
          <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
            ...
            <p className="text-slate-600 leading-relaxed">
              Gear Oil SAE 140 API GL-4 is a premium-quality, high-viscosity monograde gear lubricant formulated with carefully balanced sulfur-phosphorus extreme pressure (EP) additives to provide dependable protection under heavy load and high-temperature operating conditions. It is specifically designed for manual transmissions, steering gearboxes, and axle drives requiring API GL-4 performance, offering excellent wear protection while remaining compatible with yellow metal components such as brass and bronze synchronizers. The oil delivers strong resistance to oxidation and thermal degradation, along with effective rust and corrosion protection, ensuring reliable lubrication, smooth gear operation, reduced noise, and extended service life in demanding applications.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Standard:</strong> API GL-4, SAE J306
              </div>
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Viscosity:</strong> SAE 140
              </div>
            </div>

            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20GEAR%20OIL%20SAE%20140,%20API%20GL-4."
                target="_blank"
              ...
              <a
                href="/pdf/08_GEAR OIL SAE 140 API GL-4 copy.pdf"
                download
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 pt-12 border-t border-gray-100">
          <div className="space-y-6 scroll-reveal">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Good seal compatibility and anti-foam properties.</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
              ...
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Maintains lubrication under low-speed, high-torque conditions</strong></span>
              </li>
            </ul>
            ...
            <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
              ...
              <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                <li><strong>Suitable for high ambient temperatures and severe service conditions</strong></li>
                <li><strong>Heavy-duty manual transmissions</strong></li>
                <li><strong>Automotive and industrial gear systems requiring GL-4</strong></li>
                <li><strong>Construction, mining, agricultural, and off-highway equipment</strong></li>
              </ul>
            </div>
              ...
              <table className="w-full text-left border-collapse bg-white text-sm">
                ...
                <tbody className="divide-y divide-gray-100 text-slate-600">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-4 py-3 text-right font-mono">451</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                    <td className="px-4 py-3 font-medium text-slate-800">KV @ 100°C</td>
                    <td className="px-4 py-3 text-slate-400">ASTM D445</td>
                    <td className="px-4 py-3 text-right font-mono">29.6</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
