...
const thumbnails = [
  { src: '/productimage/1L-gear-oil-sae-90-api-gl-4.png', alt: 'SBK GEAR OIL SAE 90, API GL-4 1L', label: 'SBK GEAR OIL SAE 90, API GL-4 - 1L' },
  { src: '/productimage/4L-gear-oil-sae-90-api-gl-4.png', alt: 'SBK GEAR OIL SAE 90, API GL-4 4L', label: 'SBK GEAR OIL SAE 90, API GL-4 4L' },
  { src: '/productimage/5L-gear-oil-sae-90-api-gl-4.png', alt: 'SBK GEAR OIL SAE 90, API GL-4 5L', label: 'SBK GEAR OIL SAE 90, API GL-4 5L' },
];

export default function SbkGearOilSae90Page() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-4 scroll-reveal reveal-left">
            <div className="bg-slate-50 rounded-2xl p-8 border border-gray-100 flex items-center justify-center min-h-[380px] shadow-sm relative overflow-hidden group">
              ...
              <span className="absolute top-4 left-4 bg-brand-blue text-white font-bold text-[10px] tracking-wider uppercase px-2.5 py-1 rounded">
                High-Quality Mineral-Based Monograde Oil
              </span>
            </div>
          ...
          <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
            ...
            <p className="text-slate-600 leading-relaxed">
              Gear Oil SAE 90 API GL-4 is a high-quality mineral-based monograde oil formulated with balanced sulfur-phosphorus extreme pressure (EP) additives to provide reliable protection for gears operating under moderate to heavy loads. It is specifically designed for use in manual transmissions, spiral bevel gears, and lightly loaded hypoid gear systems where API GL-4 performance is required, ensuring excellent wear protection while maintaining compatibility with yellow metals such as brass and bronze synchronizers. The oil delivers good thermal and oxidation stability, effective corrosion protection, and consistent lubrication performance, contributing to smooth gear operation, reduced noise, and extended equipment life under a wide range of operating condition.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Viscosity:</strong> SAE 90
              </div>
            </div>

            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20GEAR%20OIL%20SAE%2090,%20API%20GL-4."
                target="_blank"
              ...
              <a
                href="/pdf/07_GEAR OIL SAE 90 API GL-4 copy.pdf"
                download
          ...
          <div className="space-y-6 scroll-reveal">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-600 text-sm"><strong>Strong anti-wear and EP protection for gears</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
              ...
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Smooth gear shifting and reduced noise.</strong></span>
              </li>
            </ul>
            ...
            <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
              ...
              <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                <li><strong>Spiral bevel gears and lightly loaded hypoid gears.</strong></li>
                <li><strong>Manual transmissions.</strong></li>
                <li><strong>Steering gearboxes and transfer cases</strong></li>
              ...
              <table className="w-full text-left border-collapse bg-white text-sm">
                ...
                <tbody className="divide-y divide-gray-100 text-slate-600">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-4 py-3 text-right font-mono">205</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                    <td className="px-4 py-3 font-medium text-slate-800">KV @ 100°C</td>
                    <td className="px-4 py-3 text-slate-400">ASTM D445</td>
                    <td className="px-4 py-3 text-right font-mono">17.5</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-4 py-3 text-right font-mono">0.889</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
