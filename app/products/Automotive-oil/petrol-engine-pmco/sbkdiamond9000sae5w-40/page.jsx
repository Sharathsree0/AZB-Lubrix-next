...
const thumbnails = [
  { src: '/productimage/1L_DIAMOND-9000-SAE-5W-40,-API-SN.png', alt: 'SBK Diamond 9000 1L', label: 'SBK Diamond 9000 - 1L' },
  { src: '/productimage/4L_DIAMOND-9000-SAE-5W-40,-API-SN---Can.png', alt: 'SBK Diamond 9000 4L', label: 'SBK Diamond 9000 4L' },
  { src: '/productimage/5L_DIAMOND-9000-SAE-5W-40,-API-SN---Can.png', alt: 'SBK Diamond 9000 5L', label: 'SBK Diamond 9000 5L' },
];

export default function SbkDiamond9000Sae5w40Page() {
  const [mainImage, setMainImage] = useState({
    src: '/productimage/5L_DIAMOND-9000-SAE-5W-40,-API-SN---Can.png',
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-20 font-sans overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
            <div>
              <span className="text-brand-gold font-semibold text-sm tracking-wider uppercase">PETROL ENGINE OIL DIAMOND 9000 SAE 5W-40, API SN</span>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SBK Diamond 9000</h2>
              <p className="text-xl font-medium text-slate-500 mt-2">SAE 5W-40 | API SN</p>
            </div>

            <p className="text-slate-600 leading-relaxed">
              Petrol Engine DIAMOND 9000 Protection oils SAE 5W-40 API SN is a full-synthetic multi-grade engine oil formulated with selected mineral base oils and advanced additives to provide reliable lubrication and protection for gasoline engines, particularly older models requiring API SM performance. It offers effective control of wear, deposits, and oxidation, while maintaining stable viscosity for consistent lubrication during HIGH-temperature operation. The formulation ensures good detergency and dispersancy to prevent sludge formation and keep engine components clean, while also helping to reduce oil consumption, enhance engine durability, and support reliable performance in high-mileage engines and hot climate conditions.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Standard:</strong> API SN / ACEA A3B4
              </div>
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20PETROL%20ENGINE%20OIL%20DIAMOND%209000%20SAE%205W-40,%20API%20SN."
                target="_blank"
              ...
              <a
                href="/pdf/16_SAE 5W-40 API SN copy.pdf"
                download="SBK_Diamond_9000_SAE_5W40_API_SN_PDS.pdf"
          ...
          <div className="space-y-6 scroll-reveal">
            ...
            <div className="space-y-4 mt-6">
              ...
              <div className="bg-slate-50 p-5 rounded-xl border border-gray-200">
                <h3 className="font-bold text-slate-800 text-sm mb-2">SPECIFICATIONS &amp; RECOMMENDATIONS PRODUCT</h3>
                <ul className="text-slate-600 text-sm space-y-1 list-disc pl-4">
                  <li>API: SN</li>
                  <li>ACEA A3B4</li>
                </ul>
              ...
              <table className="w-full text-left border-collapse bg-white text-sm">
                ...
                <tbody className="divide-y divide-gray-100 text-slate-600">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-4 py-3 text-right font-mono">9.7</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-4 py-3 text-right font-mono">&ge; 140</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
