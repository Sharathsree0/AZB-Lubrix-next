...
// Gallery images for this product. Order matches the original thumbnail row.
const GALLERY_IMAGES = [
  {
    src: '/productimage/1L_DIAMOND-5000-SAE-10W-40-API-SL-Can.png',
    label: 'SBK Diamond 5000 - 1L',
  },
  {
    src: '/productimage/4L_DIAMOND-5000-SAE-10W-40-API-SL--Can.png',
    label: 'SBK Diamond 5000 4L',
  },
  {
    src: '/productimage/5L_DIAMOND-5000-SAE-10W-40-API-SL---Can.png',
    label: 'SBK Diamond 5000 5L',
  },
];

// Technical data sheet rows.
const TDS_ROWS = [
  { param: 'Appearance', method: 'Visual', value: 'Clear and bright' },
  { param: 'KV @ 40\u00b0C', method: 'ASTM D445', value: '95' },
  { param: 'KV @ 100\u00b0C', method: 'ASTM D445', value: '14' },
  { param: 'Viscosity Index', method: 'ASTM D2270', value: '130' },
  { param: 'Density @ 15\u00b0C', method: 'ASTM D4052', value: '0.864' },
  { param: 'Flash Point', method: 'ASTM D92', value: '\u2265 210' },
  { param: 'Pour Point', method: 'ASTM D97', value: '-42' },
  { param: 'CCS @ -25\u00b0C', method: 'ASTM D5293', value: '6100' },
  { param: 'TBN', method: 'ASTM D2896', value: '10.0' },
];

export default function SbkDiamond5000Page() {
  // Default active thumbnail = 5L, matching the main image shown on load.
  const [activeIndex, setActiveIndex] = useState(2);
  const revealRefs = useRef([]);

  const activeImage = GALLERY_IMAGES[activeIndex];

  // Register a DOM node for scroll-reveal animation.
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          <div className="max-w-4xl space-y-4">
            ...
            >
              High-performance multi-grade engine oil engineered to provide outstanding wear
              protection, excellent sludge control, and sustained thermal stability for modern
              passenger vehicles.
            </p>
          </div>
        </div>
          ...
          <div ref={registerReveal} className="scroll-reveal reveal-right lg:col-span-7 space-y-6">
            <div>
              <span className="text-brand-gold font-semibold text-sm tracking-wider uppercase">
                PETROL ENGINE OIL DIAMOND 5000 SAE 10W-40, API SL
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">
                SBK Diamond 5000
              </h2>
              <p className="text-xl font-medium text-slate-500 mt-2">SAE 10W-40 | API SL</p>
            </div>

            <p className="text-slate-600 leading-relaxed">
              Petrol Engine DIAMOND 5000 Protection oils SAE 10W-40 API SL is a synthetic
              ...
              particularly older models requiring API SF performance. It offers effective control
              of wear, deposits, and oxidation, while maintaining stable viscosity for consistent
              lubrication during both cold starts and high-temperature operation. The formulation
              ensures good detergency and dispersancy to prevent sludge formation and keep engine
              components clean, while also helping to reduce oil consumption, enhance engine
              durability, and support reliable performance in high-mileage engines and hot climate
              conditions.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20PETROL%20ENGINE%20OIL%20DIAMOND%205000%20SAE%2010W-40,%20API%20SL."
                target="_blank"
              ...
              <a
                href="/pdf/17_SAE 10W-40 API SL copy.pdf"
                download="SBK_Diamond_5000_SAE_10W40_API_SL_PDS.pdf"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 pt-12 border-t border-gray-100">
          ...
          <div ref={registerReveal} className="scroll-reveal space-y-6">
            ...
            <ul className="space-y-3">
              {[
                'Equipment manufacturer acceptance DIAMOND 5000 Fully-synthetic multi-grade are approved for use in a variety of engine application by leading OEMs.',
            ...
            <div className="space-y-4 mt-6">
              <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200">
                ...
                <ul className="text-slate-600 text-sm space-y-1 list-disc pl-4">
                  <li>
                    Dedicated Petrol engine oil performance DIAMOND 5000 fully-synthetic
                    multi-grade have been formulated to Light diesel engines.
                  </li>
                  <li>Naturally aspirated or turbocharged gasoline engines.</li>
                  <li>Naturally aspirated &amp; turbocharged engines</li>
                </ul>
              </div>

              <div className="bg-slate-50 p-5 rounded-xl border border-gray-200">
                <h3 className="font-bold text-slate-800 text-sm mb-2">
                  SPECIFICATIONS &amp; RECOMMENDATIONS PRODUCT
                </h3>
                <ul className="text-slate-600 text-sm space-y-1 list-disc pl-4">
                  <li>API: SL</li>
                  <li>ACEA A3B4</li>
