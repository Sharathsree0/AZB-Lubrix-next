...
export default function SBKDiamond5000() {
    // Gallery State
    const [mainImage, setMainImage] = useState('/productimage/5L_DIAMOND-5000-SAE-20W-50-API-SL---Can.png');
    const [mainLabel, setMainLabel] = useState('SBK Diamond 5000 5L');
    const [activeThumb, setActiveThumb] = useState(2);

    // Thumbnails definition
    const thumbnails = [
        { src: '/productimage/1L_DIAMOND-5000-SAE-20W-50-API-SL-Can.png', alt: 'SBK Diamond 5000 1L', desc: 'SBK Diamond 5000 - 1L' },
        { src: '/productimage/4L_DIAMOND-5000-SAE-20W-50-API-SL--Can.png', alt: 'SBK Diamond 5000 4L', desc: 'SBK Diamond 5000 4L' },
        { src: '/productimage/5L_DIAMOND-5000-SAE-20W-50-API-SL---Can.png', alt: 'SBK Diamond 5000 5L', desc: 'SBK Diamond 5000 5L' }
    ];
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                    ...
                    <div className="max-w-4xl space-y-4">
                        <h1 className="text-white font-serif text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-tight md:leading-none scroll-reveal delay-300">
                            SBK Diamond 5000 <br className="hidden md:block" />
                        ...
                        <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-2xl font-light pt-1 scroll-reveal delay-400">
                            High-performance multi-grade engine oil engineered to provide outstanding wear protection, excellent sludge control, and sustained thermal stability for modern passenger vehicles.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 py-12 md:py-20 font-sans overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
                        <div>
                            <span className="text-brand-gold font-semibold text-sm tracking-wider uppercase">PETROL ENGINE OIL DIAMOND 5000 SAE 20W-50, API SL</span>
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SBK Diamond 5000</h2>
                            <p className="text-xl font-medium text-slate-500 mt-2">SAE 20W-50 | API SL</p>
                        </div>

                        <p className="text-slate-600 leading-relaxed">
                            Petrol Engine DIAMOND 5000 Protection oils SAE 20W-50 API SL is a high-quality multi-grade engine oil formulated with selected mineral base oils and advanced additives to provide reliable lubrication and protection for gasoline engines, particularly older models requiring API SL performance. It offers effective control of wear, deposits, and oxidation, while maintaining stable viscosity for consistent lubrication during both cold starts and high-temperature operation. The formulation ensures good detergency and dispersancy to prevent sludge formation and keep engine components clean, while also helping to reduce oil consumption, enhance engine durability, and support reliable performance in high-mileage engines and hot climate conditions.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
                            <a href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20PETROL%20ENGINE%20OIL%20DIAMOND%205000%20SAE%2020W-50,%20API%20SL." target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-brand-blue hover:bg-opacity-90 text-white font-medium rounded-lg shadow-md transition duration-200 text-sm flex items-center gap-2">
                                <i className="fab fa-whatsapp text-lg"></i> Inquire About This Product
                            </a>
                            <a href="pdf/26_SAE 20W-50 API SL copy.pdf" download="SBK_Diamond_5000_SAE_20W50_API_SL_PDS.pdf" className="px-6 py-3 border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium rounded-lg transition duration-200 text-sm flex items-center gap-2">
                    ...
                    <div className="space-y-6 scroll-reveal">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-slate-600 text-sm">Equipment manufacturer acceptance DIAMOND 5000 high-quality multi-grade are meets/exceeds for use in a variety of engine application by leading OEMs.</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                        ...
                        <div className="space-y-4 mt-6">
                            <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200">
                                ...
                                <ul className="text-slate-600 text-sm space-y-1 list-disc pl-4">
                                    <li>Dedicated Petrol engine oil performance DIAMOND 5000 high-quality multi-grade have been formulated to Passenger cars and light-duty gasoline vehicles.</li>
                            ...
                            <table className="w-full text-left border-collapse bg-white text-sm">
                                ...
                                <tbody className="divide-y divide-gray-100 text-slate-600">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-4 py-3 text-right font-mono">0.882</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
