...
const thumbnails = [
  { src: '/productimage/1L-atf-dct.png', alt: 'SBK AUTOMATIC TRANSMISSION FLUID DCT 1L', label: 'SBK AUTOMATIC TRANSMISSION FLUID DCT - 1L' },
  { src: '/productimage/4L-atf-dct.png', alt: 'SBK AUTOMATIC TRANSMISSION FLUID DCT 4L', label: 'SBK AUTOMATIC TRANSMISSION FLUID DCT 4L' },
  { src: '/productimage/5L-atf-dct.png', alt: 'SBK AUTOMATIC TRANSMISSION FLUID DCT 5L', label: 'SBK AUTOMATIC TRANSMISSION FLUID DCT 5L' },
];

export default function SbkAtfDctPage() {
  const [mainImage, setMainImage] = useState({
    src: '/productimage/5L-atf-dct.png',
    alt: ' SBK AUTOMATIC TRANSMISSION FLUID DCT',
  });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          <div className="lg:col-span-5 space-y-4 scroll-reveal reveal-left">
            <div className="bg-slate-50 rounded-2xl p-8 border border-gray-100 flex items-center justify-center min-h-[380px] shadow-sm relative overflow-hidden group">
              <div className="text-center w-full h-full flex flex-col items-center justify-center">
                ...
                <span className="inline-block mt-4 px-4 py-1 bg-brand-light text-brand-blue font-semibold text-xs rounded-full uppercase tracking-wider">DCT </span>
              </div>
          ...
          <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SBK AUTOMATIC TRANSMISSION FLUID DCT</h2>
              <p className="text-xl font-medium text-slate-500 mt-2"></p>
            </div>

            <p className="text-slate-600 leading-relaxed">
              Automatic Transmission Fluid (ATF) DCT is a specially formulated lubricant designed for dual-clutch transmissions
              (DCT), providing precise control and protection for the complex wet or dry clutch systems used in modern vehicles. It
              offers excellent friction stability and thermal resistance, ensuring smooth and fast gear shifts while minimizing clutch
              wear and shudder. The fluid also delivers superior oxidation and corrosion protection, seal compatibility, and anti-foam
              performance, maintaining consistent viscosity and optimal lubrication under high load and temperature conditions. Its
              advanced formulation ensures enhanced transmission efficiency, long service life, and reliable performance in
              passenger cars, SUVs, and light-duty vehicles equipped with dual-clutch transmissions.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Standard:</strong> DCT
              </div>
            </div>

            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20AUTOMATIC%20TRANSMISSION%20FLUID%20DCT"
                target="_blank"
          ...
          <div className="space-y-6 scroll-reveal">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-600 text-sm"><strong>Excellent thermo oxidative stability</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Anti wear and corrosion protection</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>High shear stability</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Wide temperature performance range</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Superior wet clutch friction performance</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Compatible with typical transmission seals</strong></span>
              </li>
            </ul>
            ...
            <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
              ...
              <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                <li><strong>Automatic transmissions requiring DCT</strong></li>
                <li><strong>Wet Dual Clutch Transmission systems</strong></li>
              </ul>
            </div>
              ...
              <table className="w-full text-left border-collapse bg-white text-sm">
                ...
                <tbody className="divide-y divide-gray-100 text-slate-600">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-4 py-3 text-right font-mono">14000</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-4 py-3 text-right font-mono">0.84</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
