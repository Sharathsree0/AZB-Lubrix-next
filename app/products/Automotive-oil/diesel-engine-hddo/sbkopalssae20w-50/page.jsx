...
export default function SBKDieselEngineOilOpalS() {
    // Gallery State
    const [mainImage, setMainImage] = useState('/productimage/5L-opal-s-sae-20w-50-api-cf.png');
    const [mainLabel, setMainLabel] = useState('SBK OPAL S 5L');
    const [activeThumb, setActiveThumb] = useState(2);

    // Thumbnails definition
    const thumbnails = [
        { src: '/productimage/1L-opal-s-sae-20w-50-api-cf.png', alt: 'SBK OPAL TX 1L', desc: 'SBK OPAL S - 1L' },
        { src: '/productimage/4L-opal-s-sae-20w-50-api-cf.png', alt: 'SBK OPAL TX 4L', desc: 'SBK OPAL S 4L' },
        { src: '/productimage/5L-opal-s-sae-20w-50-api-cf.png', alt: 'SBK OPAL TX 5L', desc: 'SBK OPAL S 5L' }
    ];
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                    ...
                    <nav className="flex items-center space-x-2 text-xs md:text-sm text-slate-400 mb-6 scroll-reveal delay-100">
                        ...
                        <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
                        <Link href="/diesel-engine-hddo" className="hover:text-white transition">Diesel Engine HDDO</Link>
                    </nav>
                    ...
                    <div className="max-w-4xl space-y-4">
                        <h1 className="text-white font-serif text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-tight md:leading-none scroll-reveal delay-300">
                            SBK DIESEL ENGINE OIL OPAL S  <br className="hidden md:block" />
                            <span>SAE 20W- 50, API CF</span>
                        </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-4 scroll-reveal reveal-left">
                        <div className="bg-slate-50 rounded-2xl p-8 border border-gray-100 flex items-center justify-center min-h-[380px] shadow-sm relative overflow-hidden group">
                            <div className="text-center w-full h-full flex flex-col items-center justify-center">
                                ...
                                />
                                <p className="text-slate-500 font-medium text-lg">SBK OPAL S</p>
                    ...
                    <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">DIESEL ENGINE OIL OPAL S SAE 20W-50, API CF</h2>
                            <p className="text-xl font-medium text-slate-500 mt-2"></p>
                        </div>

                        <p className="text-slate-600 leading-relaxed">
                            Diesel Engine OPAL S Protection oils feature proven lubricant chemistry that adapts to your driving needs to provide extra protection whatever the demands of your engine or equipment. Featuring an active-detergent system to keep pistons and other engine parts clean, it provides protection against wear for long engine life and protection against deposits for efficient engine performance.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-3 pt-2">
                            ...
                            <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                                <strong>Standard:</strong> API: CF, ACEA B2
                            </div>
                            <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                        ...
                        <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
                            <a href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20DIESEL%20ENGINE%20OIL%20OPAL%20S%20SAE%2020W-50,%20API%20CF." target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-brand-blue hover:bg-opacity-90 text-white font-medium rounded-lg shadow-md transition duration-200 text-sm flex items-center gap-2">
                                <i className="fab fa-whatsapp text-lg"></i> Inquire About This Product
                            </a>
                            <a href="/pdf/23_SAE 20W-50 API CF copy.pdf" download className="px-6 py-3 border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium rounded-lg transition duration-200 text-sm flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 pt-12 border-t border-gray-100">
                    ...
                    <div className="space-y-6 scroll-reveal">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>High standard of piston cleanliness</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>The high thermal stability and oil oxidation resistance provide a high standard of piston cleanliness.</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                                <span className="text-slate-600 text-sm"><strong>Low engine wear and long component life Overall engine cleanliness contributes to low engine wear,long component life, maintenance of power output, more operational stability and lower servicing costs.</strong></span>
                            </li>
                        </ul>
                        ...
                        <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
                            ...
                            <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                                <li><strong>Dedicated diesel engine oil performance OPAL S multigrade have been formulated to provide robust engine performance in a variety of off-highway applications or older on-highway diesel vehicles</strong></li>
                                <li><strong>Construction industry application Engine oil technology is sometimes specified for use in the transmission and hydraulic applications. OPAL S multigrade offer premium performance and protection for these applications.</strong></li>
                                <li><strong>Stationary equipment OPAL S multigrade are suitable for certain stationary equipment, such as pumps, that run continuously under steady state conditions</strong></li>
                            </ul>
                        </div>
                            ...
                            <table className="w-full text-left border-collapse bg-white text-sm">
                                ...
                                <tbody className="divide-y divide-gray-100 text-slate-600">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-4 py-3 text-right font-mono">156</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-4 py-3 text-right font-mono">0.881</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-4 py-3 text-right font-mono">-24</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
