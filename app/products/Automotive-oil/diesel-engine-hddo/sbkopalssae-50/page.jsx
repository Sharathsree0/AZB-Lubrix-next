...
const GALLERY_IMAGES = [
  {
    src: '/productimage/1L-opal-s-sae-50-api-cf.png',
    label: 'SBK OPAL S SAE-50 - 1L',
  },
  {
    src: '/productimage/4L-opal-s-sae-50-api-cf.png',
    label: 'SBK OPAL S SAE-50 4L',
  },
  {
    src: '/productimage/5L-opal-s-sae-50-api-cf.png',
    label: 'SBK OPAL S SAE-50 5L',
  },
];

const TDS_ROWS = [
  { param: 'Appearance', method: 'Visual', value: 'Clear and bright' },
  { param: 'KV @ 40\u00b0C', method: 'ASTM D445', value: '236' },
  { param: 'KV @ 100\u00b0C', method: 'ASTM D445', value: '19.2' },
  { param: 'Viscosity Index', method: 'ASTM D2270', value: '\u2265 90' },
  { param: 'Density @ 15\u00b0CC', method: 'ASTM D4052', value: '0.891' },
  { param: 'Flash Point', method: 'ASTM D92', value: '\u2265 220' },
  { param: 'Pour Point', method: 'ASTM D97', value: '-9' },
  { param: 'TBN', method: 'ASTM D2896', value: '6' },
];

export default function OpalSPage() {
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          >
            ...
            <i className="fas fa-chevron-right text-[10px] text-slate-500" />
            <Link href="/diesel-engine-hddo" className="text-white font-medium">
              Diesel Engine HDDO
            </Link>
          </nav>
          ...
          <div ref={registerReveal} className="scroll-reveal reveal-right lg:col-span-7 space-y-6">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">
                DIESEL ENGINE OIL OPAL S SAE-50, API CF
              </h2>
              <p className="text-xl font-medium text-slate-500 mt-2" />
            </div>

            <p className="text-slate-600 leading-relaxed">
              Diesel Engine OPAL S SAE 50 Protection oils feature proven lubricant chemistry that
              adapts to your driving needs to provide extra protection whatever the demands of
              your engine or equipment. Featuring an active-detergent system to keep pistons and
              other engine parts clean, it provides protection against wear for long engine life
              and protection against deposits for efficient engine performance.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Standard:</strong> API: CF, ACEA E7
              </div>
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Viscosity:</strong> SAE 50
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20DIESEL%20ENGINE%20OIL%20OPAL%20S%20SAE%2050,%20API%20CF."
                target="_blank"
              ...
              <a
                href="/pdf/27_SAE 50 CF copy.pdf"
                download
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 pt-12 border-t border-gray-100">
          ...
          <div ref={registerReveal} className="scroll-reveal space-y-6">
            ...
            <ul className="space-y-3">
              {[
                'Equipment manufacturer acceptance OPAL S SAE 50 monograde are meets/exceeds for use in a variety of engine application by leading OEMs.',
            ...
            <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
              ...
              <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                <li>
                  <strong>
                    Dedicated diesel engine oil performance OPAL S monograde have been formulated
                ...
                <li>
                  <strong>
                    ...
                    for use in the transmission and hydraulic applications. OPAL S monograde offer
                    premium performance and protection for these applications.
                  </strong>
                </li>
                <li>
                  <strong>
                    Stationary equipment OPAL S monograde are suitable for certain stationary
