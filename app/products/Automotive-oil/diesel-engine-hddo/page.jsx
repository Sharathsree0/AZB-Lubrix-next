                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                        ...
                        <main className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                {/* 1. SBK DIESEL ENGINE OIL OPAL MIS 9400 SAE 15W-40 API CK-4 */}
                                <Link href="/products/Automotive-oil/diesel-engine-hddo/sbkdieselopalmis9400sae15w-40ck-4" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                ...
                                {/* 2. SBK DIESEL ENGINE OIL OPAL MIS 9400 SAE 15W-40 API CJ-4 */}
                                <Link href="/products/Automotive-oil/diesel-engine-hddo/sbkdieselopalmis9400sae15w-40cj-4" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                ...
                                {/* 3. SBK DIESEL ENGINE OIL OPAL MIS 4700 SAE 15W-40 */}
                                <Link href="/products/Automotive-oil/diesel-engine-hddo/sbkdieselopalmis4700sae15w-40ci-4" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                ...
                                {/* 4. SBK DIESEL ENGINE OIL OPAL TX SAE 15W-40 */}
                                <Link href="/products/Automotive-oil/diesel-engine-hddo/sbkdieselopaltxsae15w-40cf-4" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                ...
                                {/* 5. SBK DIESEL ENGINE OIL OPAL S SAE 20W-50 */}
                                <Link href="/products/Automotive-oil/diesel-engine-hddo/sbkopalssae20w-50" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                ...
                                {/* 6. SBK DIESEL ENGINE OIL OPAL TX SAE 20W-50 */}
                                <Link href="/products/Automotive-oil/diesel-engine-hddo/sbkopaltxsae20w-50" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                ...
                                {/* 7. SBK DIESEL ENGINE OIL OPAL S SAE 50 */}
                                <Link href="/products/Automotive-oil/diesel-engine-hddo/sbkopalssae-50" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                ...
                                {/* 8. SBK SOUW-32 Diesel Exhaust Fluid */}
                                <Link href="/products/Industrial-Lubricants/diesel-exhaust-fluid/sbk-souw-32" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <img src="/productimage/souw325L.png" alt="SBK SOUW-32 Diesel Exhaust Fluid" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md"/>
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-green-600 uppercase tracking-wider mb-1 block">DIESEL EXHAUST FLUID (DEF)</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-green-600 transition tracking-tight mb-2 line-clamp-2">
                                            SBK SOUW-32
                                        </h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">
                                            High-purity Diesel Exhaust Fluid engineered for peak performance in SCR systems, protecting against deposits and maximizing fleet uptime under demanding heavy-duty conditions.
                                        </p>
                                        <div className="border-t border-gray-100 pt-4 mt-auto">
                                            <div className="w-full py-2 bg-slate-800 group-hover:bg-green-600 text-white text-xs font-bold rounded-lg transition-colors flex justify-center items-center gap-1.5 shadow-sm">
                                                Specifications <i className="fas fa-arrow-right text-[10px]"></i>
