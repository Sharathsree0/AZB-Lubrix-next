...
const GALLERY_IMAGES = [
  {
    src: '/productimage/1L_OPAL-MIS-9400-SAE-15W-40-API--CJ-4-Can.png',
    label: 'SBK OPAL MIS 9400 - 1L',
  },
  {
    src: '/productimage/4L_OPAL-MIS-9400-SAE-15W-40-API--CJ-4-Can.png',
...
const TDS_ROWS = [
  ...
  { param: 'Viscosity Index', method: 'ASTM D2270', value: '\u2265 120' },
  { param: 'Density @ 15\u00b0C', method: 'ASTM D4052', value: '0.878' },
  ...
  { param: 'TBN', method: 'ASTM D2896', value: '8.2' },
];

export default function OpalMis9400Page() {
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          <div className="max-w-4xl space-y-4">
            ...
            >
              Premium heavy-duty multi-grade diesel engine oil engineered to provide advanced wear
              protection, exceptional soot control, and emission system compatibility for
          ...
          <div ref={registerReveal} className="scroll-reveal reveal-right lg:col-span-7 space-y-6">
            <div>
              <span className="text-brand-gold font-semibold text-sm tracking-wider uppercase">
                High-Performance Heavy-Duty Diesel Engine Oils
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">
                DIESEL ENGINE OIL OPAL MIS 9400 SAE 15W-40, API CJ-4
              </h2>
              <p className="text-xl font-medium text-slate-500 mt-2">SAE 15W-40 | API CJ-4</p>
            </div>
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              modern low-emission diesel engines. It meets the requirements of the API CJ-4
              specification and is designed for high-speed, four-stroke diesel engines equipped
              with advanced emission control systems such as EGR and DPF making it suitable for
              use with ultra-low sulfur diesel (ULSD) fuel while remaining backward compatible with
              earlier API categories. Its SAE 15W-40 viscosity ensures excellent low-temperature
              flow for easy cold starts and maintains a stable lubricating film at high operating
              temperatures, delivering reliable performance across a wide range of operating
              conditions.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Standard:</strong> API: CJ-4 / ACEA E8E9
              </div>
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20DIESEL%20ENGINE%20OIL%20OPAL%20MIS%209400%20SAE%2015W-40,%20API%20CJ-4."
                target="_blank"
              ...
              <a
                href="/pdf/21_SAE 15W-40 API CJ-4 copy.pdf"
                download
            ...
            <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
              ...
              <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                <li>
                  ...
                  15W-40 SN and below performance oil is recommended.
                </li>
