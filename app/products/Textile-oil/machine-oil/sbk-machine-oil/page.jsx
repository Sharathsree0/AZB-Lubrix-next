...
export default function MachineOil() {
    // Gallery State
    const [mainImage, setMainImage] = useState('/img/Drum-Red-(2).png');
    const [mainLabel, setMainLabel] = useState('SBK MACHINE OIL');
    const [activeThumb, setActiveThumb] = useState(0);

    // Thumbnails definition
    const thumbnails = [
        { src: '/img/Drum-Red-(2).png', alt: 'SBK MACHINE OIL 1L', desc: 'SBK MACHINE OIL  - pail' },
        { src: '/img/Drum-Red-(2).png', alt: 'SBK MACHINE OIL 4L', desc: 'SBK MACHINE OIL  drum' },
        { src: '/img/Drum-Red-(2).png', alt: 'SBK MACHINE OIL 5L', desc: 'SBK MACHINE OIL  IBC' }
    ];
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                    ...
                    <nav className="flex items-center space-x-2 text-xs md:text-sm text-slate-400 mb-6 scroll-reveal delay-100">
                        ...
                        <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
                        <span className="text-white font-medium">MACHINE OIL</span>
                    </nav>
                    ...
                    <div className="max-w-4xl space-y-4">
                        <h1 className="text-white font-serif text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-tight md:leading-none scroll-reveal delay-300">
                            SBK MACHINE OIL   <br className="hidden md:block" />
                            <span> </span>
                        </h1>
                        
                        <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-2xl font-light pt-1 scroll-reveal delay-400">
                            SBK Machine Oil is a highly refined mineral base oil formulated for high-speed machine components requiring low 
                            friction, good cooling, and excellent oxidation stability. It provides smooth lubrication for precision machinery operating 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SBK MACHINE OIL</h2>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
                            <a href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20MCHINE%20OIL" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-brand-blue hover:bg-opacity-90 text-white font-medium rounded-lg shadow-md transition duration-200 text-sm flex items-center gap-2">
                                <i className="fab fa-whatsapp text-lg"></i> Inquire About This Product
                            </a>
                            <a href="pdf/04-Machine-oil.pdf" download className="px-6 py-3 border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium rounded-lg transition duration-200 text-sm flex items-center gap-2">
                    ...
                    <div className="space-y-6 scroll-reveal">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-slate-600 text-sm"><strong>Excellent oxidation stability for long service life</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <svg className="w-5 h-5 text-emerald-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                </svg>
                                <span className="text-slate-600 text-sm"><strong>Low viscosity for fast heat dissipation</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <svg className="w-5 h-5 text-emerald-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                </svg>
                                <span className="text-slate-600 text-sm"><strong>Good rust and corrosion protection</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <svg className="w-5 h-5 text-emerald-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                </svg>
                                <span className="text-slate-600 text-sm"><strong>Smooth operation in high-speed systems</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <svg className="w-5 h-5 text-emerald-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                </svg>
                                <span className="text-slate-600 text-sm"><strong>Minimal foaming and stable lubrication film</strong></span>
                            </li>
                            <li className="flex items-start gap-3">
                                <svg className="w-5 h-5 text-emerald-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                </svg>
                                <span className="text-slate-600 text-sm"><strong>Clean operation with low deposit formation</strong></span>
                            </li>
                        </ul>
                        ...
                        <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
                            ...
                            <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                                <li><strong>Machine tool spindles</strong></li>
                                <li><strong>Textile machinery (knitting & weaving machines)</strong></li>
                                <li><strong>Light circulating systems</strong></li>
                                <li><strong>High-speed bearings</strong></li>
                                <li><strong>Low-pressure hydraulic systems</strong></li>
                                <li><strong>General industrial lubrication systems</strong></li>
                            </ul>
                        </div>

                        <div className="bg-slate-50 p-4 rounded-xl border border-gray-200">
                            <h3 className="font-bold text-slate-800 text-xs uppercase tracking-wider mb-2">SPECIFICATIONS, APPROVALS & RECOMMENDATIONS</h3>
                            <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                                <li>SBK Machine Oil is a light R&O industrial lubricant designed for high-speed spindles, textile machinery, and precision equipment under low-load conditions, offering good oxidation stability, rust protection, and smooth lubrication performance, but it is not suitable for heavy-duty or EP gear applications.</li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <table className="w-full text-left border-collapse bg-white text-sm min-w-[500px]">
                                ...
                                <tbody className="divide-y divide-gray-100 text-slate-600">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-3 py-3 text-center font-mono">32.0</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">KV @ 100°C</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D445</td>
                                        <td className="px-3 py-3 text-center font-mono">54.43</td>
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-3 py-3 text-center font-mono">109</td>
                                        <td className="px-3 py-3 text-center font-mono">96</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Density @ 15°C</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D4052</td>
                                        <td className="px-3 py-3 text-center font-mono">0.8492</td>
                                        <td className="px-3 py-3 text-center font-mono">0.8723</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Flash Point</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D92</td>
                                        <td className="px-3 py-3 text-center font-mono">&ge; 190</td>
                                        <td className="px-3 py-3 text-center font-mono">&ge; 190</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
