                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <Link href="#" className="hover:text-green-500 transition">TEXTILE OIL </Link>
                            <span>/</span>
                            <span className="text-green-400">MACHINE OIL</span>
                        </nav>
                        ...
                        <span className="hidden md:inline-block inline-block bg-red-600 text-white text-xs font-bold uppercase tracking-widest px-3 py-1 rounded mb-4 shadow-lg">
                            High Performance MACHINE OIL
                        </span>
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
                           MACHINE <span className="text-green-400">OIL</span>
                        </h1>
                        <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
                            Formulated for multi-purpose industrial equipment and general machinery. Delivers reliable anti-wear protection, optimal thermal stability, and effective rust prevention to ensure smooth mechanical operation and extend equipment service life.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                        ...
                        <main className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <Link href="/products/Textile-oil/machine-oil/sbk-machine-oil" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    ...
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Machine Oil</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-green-600 transition tracking-tight mb-2 line-clamp-2">SBK MACHINE OIL</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Versatile multi-purpose industrial lubricant formulated for general machinery, providing reliable anti-wear protection, smooth mechanical motion, and robust oxidation stability.</p>
