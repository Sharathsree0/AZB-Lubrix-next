...
export default function SbkSpindleOilDetailPage() {
    // State to handle the interactive image gallery
    const [galleryState, setGalleryState] = useState({
        img: '/img/Drum-Red-(2).png',
        text: 'SBK SPINDLE OIL',
        activeIndex: 0
    });

    const thumbnails = [
        { img: '/img/Drum-Red-(2).png', text: 'SBK SPINDLE OIL - pail' },
        { img: '/img/Drum-Red-(2).png', text: 'SBK SPINDLE OIL drum' },
        { img: '/img/Drum-Red-(2).png', text: 'SBK SPINDLE OIL IBC' }
    ];
            ...
            >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                    ...
                    <nav className="flex items-center space-x-2 text-xs md:text-sm text-slate-400 mb-6 scroll-reveal delay-100">
                        ...
                        <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
                        <Link href="/products/Textile-oil/spindle-oil" className="hover:text-white transition">TEXTILE OIL</Link>
                        <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
                        <span className="text-white font-medium">SPINDLE OIL</span>
                    </nav>
                    ...
                    <div className="max-w-4xl space-y-4">
                        ...
                        <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-2xl font-light pt-1 scroll-reveal delay-400">
                            SBK Spindle Oil is a high-quality low-viscosity lubricant formulated from premium mineral base oils and specially selected additives to provide excellent lubrication, oxidation stability, rust protection, and smooth operation in high-speed spindle and precision machinery applications. It is designed to ensure efficient performance where rapid oil circulation and minimal friction are required.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
                        ...
                        <div className="flex flex-wrap gap-3 pt-2">
                            ...
                            <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                                <strong>Viscosity Grades:</strong> ISO VG 10, 15, 22
                            </div>
                        </div>

                        <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
                            <a href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20SBK%20SPINDLE%20OIL" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-brand-blue hover:bg-opacity-90 text-white font-medium rounded-lg shadow-md transition duration-200 text-sm flex items-center gap-2">
                                <i className="fab fa-whatsapp text-lg"></i> Inquire About This Product
                            </a>
                            <a href="/pdf/15-SPINDLE-Oil.pdf" download className="px-6 py-3 border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium rounded-lg transition duration-200 text-sm flex items-center gap-2">
                    ...
                    <div className="space-y-6 scroll-reveal">
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                "Good anti-wear characteristics",
                                "Excellent filterability and cleanliness",
                                "Rapid oil circulation and heat dissipation",
                        ...
                        <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
                            ...
                            <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                                <li><strong>High-speed textile spindles</strong></li>
                                <li><strong>Precision machine tools</strong></li>
                                <li><strong>Light hydraulic systems</strong></li>
                                <li><strong>Industrial sewing machines</strong></li>
                                <li><strong>Bearings and circulating systems</strong></li>
                                <li><strong>CNC spindle lubrication systems</strong></li>
                                <li><strong>Light-duty lubrication applications requiring ISO VG oil</strong></li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-slate-50 p-4 rounded-xl border border-gray-200">
                            ...
                            <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                                <li>ISO VG 10, 15, 22</li>
                                <li>DIN 51524</li>
                                <li>Suitable for spindle and light industrial lubrication applications</li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <table className="w-full text-left border-collapse bg-white text-sm min-w-[500px]">
                                ...
                                <tbody className="divide-y divide-gray-100 text-slate-600">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-3 py-3 text-center font-mono">&ge;90</td>
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-3 py-3 text-center font-mono">-27</td>
