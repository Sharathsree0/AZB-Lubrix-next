  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/productbanner/dieselexhaustfluid.jpeg')" }}
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <nav className="flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
              ...
              <span>/</span>
              <span className="text-green-400">Diesel Exhaust Fluid</span>
            </nav>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
              Diesel Exhaust <span className="text-green-400">Fluid</span>
            </h1>
            <p className="text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
              Discover our comprehensive range of high-purity Diesel Exhaust Fluid (DEF) solutions. Engineered for peak performance, our fluids maximize fleet uptime, ensure superior SCR system protection, and maintain smooth, clean emissions control under the most demanding heavy-duty operating conditions.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
            ...
            <main className="lg:col-span-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* 1. SBK SOUW-32 */}
                <Link
                  href="/products/Industrial-Lubricants/diesel-exhaust-fluid/sbk-souw-32"
                ...
                >
                  <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                    ...
                    <img
                      src="/productimage/souw325L.png"
                      alt="SBK SOUW-32 Diesel Exhaust Fluid"
