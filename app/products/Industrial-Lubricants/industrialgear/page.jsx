...
export default function IndustrialGearOilPage() {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
              ...
              <span>/</span>
              <span className="text-green-400">Industrial Gear Oil</span>
            </nav>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
              Industrial Gear <span className="text-green-400">Oil</span>
            </h1>
            <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
              Discover our comprehensive range of high-performance industrial gear oils—engineered to prevent micropitting, cushion heavy shock loads, and extend gearbox component life under extreme pressure and severe thermal stress.
            </p>
          </div>
        </div>
      </section>
            ...
            <main className="lg:col-span-3">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 gap-4">
                <div className="border-b border-gray-200 pb-6 mb-8">
                  <h2 className="text-2xl md:text-3xl font-extrabold text-green-600 tracking-tight">Industrial Gear Oil</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="#" onClick={handleCardClick} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                  <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                    ...
                    <img src="/img/Drum-Red-(2).png" alt="SBK Reduction Gear Oil" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                  </div>
                  <div className="p-5 flex flex-col flex-grow">
                    <span className="text-[10px] font-bold text-green-600 uppercase tracking-wider mb-1 block">HEAVY-DUTY GEAR LUBRICANT</span>
                    <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-green-600 transition tracking-tight mb-2 line-clamp-2">
                      SBK REDUCTION GEAR OIL
                    </h3>
                    <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">
                      Heavy-duty industrial gear oil formulated with extreme-pressure additives to protect reduction gearboxes against micropitting, gear tooth wear, and high shock loads.
                    </p>
