...
export default function SbkTurbineOilPage() {
    // State to handle the interactive image gallery
    const [galleryState, setGalleryState] = useState({
        img: '/img/Drum-Red-(2).png',
        text: 'SBK TURBINE OIL',
        activeIndex: 0
    });

    const thumbnails = [
        { img: '/img/Drum-Red-(2).png', text: 'SBK TURBINE OIL - Pail' },
        { img: '/img/Drum-Red-(2).png', text: 'SBK TURBINE OIL - Drum' },
        { img: '/img/Drum-Red-(2).png', text: 'SBK TURBINE OIL - IBC' }
    ];
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                    ...
                    <nav className="flex items-center space-x-2 text-xs md:text-sm text-slate-400 mb-6 scroll-reveal delay-100">
                        ...
                        <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
                        <Link href="/Industrial-Lubricants/turbineoil" className="hover:text-white transition">Industrial Oils</Link>
                        <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
                        <span className="text-white font-medium">SBK TURBINE OIL</span>
                    </nav>
                    ...
                    <div className="max-w-4xl space-y-4">
                        <h1 className="text-white font-serif text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-tight md:leading-none scroll-reveal delay-300">
                            SBK TURBINE OIL <br className="hidden md:block" />
                            <span> </span>
                        </h1>
                        
                        <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-2xl font-light pt-1 scroll-reveal delay-400">
                            SBK Turbine Oil is a premium-quality rust and oxidation inhibited (R&O) circulating oil formulated from highly refined mineral base oils and advanced additive technology. It is designed to provide outstanding oxidation stability, water separation, corrosion protection, and foam control for steam, gas, and hydro turbines operating under severe service conditions.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SBK TURBINE OIL</h2>
                            <p className="text-xl font-medium text-slate-500 mt-2">PREMIUM TURBINE & CIRCULATING OIL</p>
                        </div>

                        <p className="text-slate-600 leading-relaxed">
                            SBK Turbine Oil is a premium-quality rust and oxidation inhibited (R&O) circulating oil formulated from highly refined mineral base oils and advanced additive technology. It is designed to provide outstanding oxidation stability, water separation, corrosion protection, and foam control for steam, gas, and hydro turbines operating under severe service conditions. It is suitable for turbine lubrication systems, governors, bearings, gearboxes, and auxiliary hydraulic systems.
                        </p>

                        <div className="flex flex-wrap gap-3 pt-2">
                            <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                                <strong>Quantity:</strong> 20 lit,drum, IBC
                            </div>
                            <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                        ...
                        <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
                            <a href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20SBK%20TURBINE%20OIL" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-brand-blue hover:bg-opacity-90 text-white font-medium rounded-lg shadow-md transition duration-200 text-sm flex items-center gap-2">
                                <i className="fab fa-whatsapp text-lg"></i> Inquire About This Product
                            </a>
                            <a href="/pdf/06-SBK TURBINE OIL copy.pdf" download className="px-6 py-3 border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium rounded-lg transition duration-200 text-sm flex items-center gap-2">
                    ...
                    <div className="space-y-6 scroll-reveal">
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                "Long service life",
                                "Good wear protection for bearings and gears",
                        ...
                        <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
                            ...
                            <ul className="text-slate-600 text-sm leading-relaxed space-y-1 list-disc pl-4">
                                ...
                                <li>Combined-cycle turbines</li>
                                <li>Turbine gearboxes</li>
                                <li>Circulating oil systems</li>
                                <li>Hydraulic control systems</li>
                                <li>Industrial bearings and compressors requiring R&O oils</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-slate-50 p-4 rounded-xl border border-gray-200">
                            ...
                            <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                                <li>DIN 51515 Part 1 & 2</li>
                                <li>ISO 8068</li>
                                <li>ASTM D4304 Type I & II</li>
                                <li>BS 489</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="overflow-hidden border border-gray-200 rounded-xl shadow-sm overflow-x-auto">
                            <table className="w-full text-left border-collapse bg-white text-sm min-w-[500px]">
                                ...
                                <tbody className="divide-y divide-gray-100 text-slate-600">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">KV @ 100°C (cSt)</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D445</td>
                                        <td className="px-2 py-3 text-center font-mono">5.5</td>
                                        <td className="px-2 py-3 text-center font-mono">7.1</td>
                                        <td className="px-2 py-3 text-center font-mono">8.9</td>
                                        <td className="px-2 py-3 text-center font-mono">11.5</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Viscosity Index</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D2270</td>
                                        <td className="px-2 py-3 text-center font-mono">108</td>
                                        <td className="px-2 py-3 text-center font-mono">113</td>
                                        <td className="px-2 py-3 text-center font-mono">104</td>
                                        <td className="px-2 py-3 text-center font-mono">102</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                        <td className="px-4 py-3 font-medium text-slate-800">Density @ 15°C (g/cm³)</td>
                                        <td className="px-4 py-3 text-slate-400">ASTM D4052</td>
                                        <td className="px-2 py-3 text-center font-mono">0.8559</td>
                                        <td className="px-2 py-3 text-center font-mono">0.8573</td>
                                        <td className="px-2 py-3 text-center font-mono">0.8624</td>
                                        <td className="px-2 py-3 text-center font-mono">0.8771</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50/50">
                                    ...
                                    <tr className="hover:bg-slate-50/50">
                                        ...
                                        <td className="px-2 py-3 text-center font-mono">-18</td>
                                        <td className="px-2 py-3 text-center font-mono">-18</td>
