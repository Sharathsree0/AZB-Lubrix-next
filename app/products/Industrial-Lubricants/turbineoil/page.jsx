...
const products = [
  {
    ...
    badgeCategory: 'TURBINE LUBRICANT',
    name: 'SBK TURBINE OIL',
    description: 'Premium industrial turbine oil engineered with high oxidation stability, excellent demulsibility, and rapid air release to prevent varnish formation and safeguard critical bearings.',
    href: '/products/Industrial-Lubricants/turbineoil/sbk-turbine-oil', 
  }
];
...
export default function TurbineOil() {
    ...
    const openNoticeModal = () => setModalOpen(true);
