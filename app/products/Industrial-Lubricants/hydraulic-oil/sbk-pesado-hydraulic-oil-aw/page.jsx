...
const thumbnails = [
  { src: '/productimage/1Lsbkpesadohydraulicoilaw.png', alt: 'SBK PESADO Hydraulic Oil AW - 1L', label: 'SBK PESADO Hydraulic Oil AW - 1L' },
  { src: '/productimage/4Lsbkpesadohydraulicoilaw.png', alt: 'SBK PESADO Hydraulic Oil AW 4L', label: 'SBK PESADO Hydraulic Oil AW 4L' },
  { src: '/productimage/5Lsbkpesadohydraulicoilaw.png', alt: 'SBK PESADO Hydraulic Oil AW 5L', label: 'SBK PESADO Hydraulic Oil AW 5L' },
];

export default function SbkPesadoHydraulicOilAwPage() {
  // Main viewport starts on the 5L image/label (matches original markup),
  // while thumbnail 0 (1L) starts highlighted as active — that mismatch is
  // in the source PHP too, kept as-is rather than "fixed".
  const [mainImage, setMainImage] = useState({
    src: '/productimage/5Lsbkpesadohydraulicoilaw.png',
    alt: ' SBK PESADO Hydraulic Oil AW',
  });
  const [mainLabel, setMainLabel] = useState('SBK PESADO Hydraulic Oil');
  ...
  // Scroll-reveal observer — local to this page (mirrors our-team.jsx's
  // pattern), since every product-detail page manages its own reveal set.
  useEffect(() => {
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(3, 7, 18, 0.95) 30%, rgba(3, 7, 18, 0.6) 70%, rgba(3, 7, 18, 0.4) 100%), url('/productbanner/industrial.jpg')",
        }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          <nav className="flex items-center space-x-2 text-xs md:text-sm text-slate-400 mb-6 scroll-reveal delay-100">
            ...
            <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
            <Link href="/hydraulic-oil" className="text-white font-medium">Hydraulic Oil</Link>
          </nav>
          ...
          <div className="max-w-4xl space-y-4">
            <h1 className="text-white font-serif text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-tight md:leading-none scroll-reveal delay-300">
              SBK PESADO Hydraulic Oil <br className="hidden md:block" />
              <span>AW </span>
            </h1>

            <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-2xl font-light pt-1 scroll-reveal delay-400">
              PESADO Hydraulic Oil AW is a high quality anti wear (AW) hydraulic fluid formulated from refined base oils and a balanced
              additive system. It is designed to provide excellent protection against wear, rust, oxidation, foaming and air entrainment
              in hydraulic systems operating under moderate to severe conditions
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SBK PESADO Hydraulic Oil AW</h2>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Quantity:</strong> 1 Lit, 4 Lit, 5 Lit,pail,drum
              </div>
              <div className="bg-slate-100 px-4 py-2 rounded-lg text-xs font-medium text-slate-700 border border-slate-200">
                <strong>Standard:</strong> AW
              </div>
            </div>

            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20SBK%20PESADO%20HYDRAULIC%20OIL%20AW"
                target="_blank"
              ...
              <a
                href="/pdf/03-HYDRAULIC-OIL-AW.pdf"
                download
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 pt-12 border-t border-gray-100">
          ...
          <div className="space-y-6 scroll-reveal">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Excellent oxidation stability and thermal performance</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Superior water separation and rapid air release</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Good corrosion and rust protection</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <i className="fas fa-check-circle text-emerald-500 mt-1 flex-shrink-0"></i>
                <span className="text-slate-600 text-sm"><strong>Suitable for both industrial and mobile equipment</strong></span>
              </li>
            </ul>
            ...
            <div className="bg-brand-light bg-opacity-40 p-5 rounded-xl border border-gray-200 mt-6">
              ...
              <ul className="text-slate-600 text-sm space-y-2 list-disc pl-4">
                <li><strong>Industrial hydraulic systems with vane, piston, or gear pumps</strong></li>
                <li><strong>Mobile hydraulic systems in construction, agriculture, mining and material handling</strong></li>
                <li><strong>Circulating systems and moderately loaded gears and bearings</strong></li>
                <li><strong>Hydraulic tools, presses, lifts and machine tools</strong></li>
              </ul>
            </div>
          ...
          <div className="space-y-4 scroll-reveal reveal-zoom">
            ...
            <div className="overflow-hidden border border-gray-200 rounded-xl shadow-sm overflow-x-auto">
              <table className="w-full text-left border-collapse bg-white text-sm min-w-[800px]">
                <thead>
                ...
                <tbody className="divide-y divide-gray-100 text-slate-600">
                  <tr className="hover:bg-slate-50/50">
                    <td className="px-4 py-3 font-medium text-slate-800">SAE Grade</td>
                    <td className="px-4 py-3 text-slate-400"></td>
                    <td className="px-3 py-3 text-center font-mono font-medium text-slate-800">AW 10</td>
                    <td className="px-3 py-3 text-center font-mono font-medium text-slate-800">AW 15</td>
                    <td className="px-3 py-3 text-center font-mono font-medium text-slate-800">AW 32</td>
                    <td className="px-3 py-3 text-center font-mono font-medium text-slate-800">AW 46</td>
                    <td className="px-3 py-3 text-center font-mono font-medium text-slate-800">AW 68</td>
                    <td className="px-3 py-3 text-center font-mono font-medium text-slate-800">AW 100</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                    <td className="px-4 py-3 font-medium text-slate-800">Appearance</td>
                    <td className="px-4 py-3 text-slate-400">Visual</td>
                    <td colSpan={6} className="px-3 py-3 text-center font-mono">Clear &amp; bright</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-3 py-3 text-center font-mono">11.2</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                  ...
                  <tr className="hover:bg-slate-50/50">
                    ...
                    <td className="px-3 py-3 text-center font-mono">0.835</td>
                    <td className="px-3 py-3 text-center font-mono">0.853</td>
                    <td className="px-3 py-3 text-center font-mono">0.8728</td>
                    <td className="px-3 py-3 text-center font-mono">0.8715</td>
                    <td className="px-3 py-3 text-center font-mono">0.878</td>
                    <td className="px-3 py-3 text-center font-mono">0.882</td>
                  </tr>
                  <tr className="hover:bg-slate-50/50">
                    <td className="px-4 py-3 font-medium text-slate-800">Flash Point</td>
                    <td className="px-4 py-3 text-slate-400">ASTM D92</td>
                    <td className="px-3 py-3 text-center font-mono">&ge; 150</td>
                    <td className="px-3 py-3 text-center font-mono">&ge; 175</td>
