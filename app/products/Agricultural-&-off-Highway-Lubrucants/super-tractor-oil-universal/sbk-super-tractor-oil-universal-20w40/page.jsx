...
const images = [
  { src: '/img/Drum-Red-(2).png', label: 'SUPER TRACTOR OIL UNIVERSAL STOU SAE 20W40' },
  { src: '/img/Drum-Red-(2).png', label: 'SUPER TRACTOR OIL UNIVERSAL STOU SAE 20W40' },
  { src: '/img/Drum-Red-(2).png', label: 'SUPER TRACTOR OIL UNIVERSAL STOU SAE 20W40' },
];

export default function SbkStou20w40Page() {
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          <nav className="flex items-center space-x-2 text-xs md:text-sm text-slate-400 mb-6 scroll-reveal delay-100">
            ...
            <i className="fas fa-chevron-right text-[10px] text-slate-500"></i>
            <span className="text-white font-medium">SUPER TRACTOR OIL UNIVERSAL STOU SAE 20W40</span>
          </nav>
          ...
          <div className="max-w-4xl space-y-4">
            <h1 className="text-white font-serif text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight leading-tight md:leading-none scroll-reveal delay-300">
              SUPER TRACTOR OIL UNIVERSAL STOU SAE 20W40
            </h1>
            <p className="text-slate-300 text-sm md:text-base leading-relaxed max-w-2xl font-light pt-1 scroll-reveal delay-400">
              SBK STOU SAE 20W-40 is a high-performance, multi-functional lubricant formulated with premium base oils and advanced additive technology. It is designed for use in engines, transmissions, hydraulic systems, and wet brake systems of agricultural and off-road equipment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-20 font-sans overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-4 scroll-reveal reveal-left">
            <div className="bg-slate-50 rounded-2xl p-8 border border-gray-100 flex items-center justify-center min-h-[380px] shadow-sm relative overflow-hidden group">
              <div className="text-center w-full h-full flex flex-col items-center justify-center">
                ...
                />
                <p className="text-slate-500 font-medium text-lg">SUPER TRACTOR OIL UNIVERSAL STOU SAE 20W40</p>
          ...
          <div className="lg:col-span-7 space-y-6 scroll-reveal reveal-right">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mt-1">SUPER TRACTOR OIL UNIVERSAL STOU SAE 20W40</h2>
            </div>

            <p className="text-slate-600 leading-relaxed">
              SBK STOU SAE 20W-40 is a high-performance, multi-functional lubricant formulated with premium base oils and advanced additive technology. It is designed for use in engines, transmissions, hydraulic systems, and wet brake systems of agricultural and off-road equipment. This universal oil ensures reliable performance under severe operating conditions while simplifying maintenance through a single oil solution.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
              <a
                href="https://wa.me/971569966391?text=Hello,%20I%20would%20like%20to%20inquire%20about%20SUPER%20TRACTOR%20OIL%20UNIVERSAL%20STOU%20SAE%2020W40"
                target="_blank"
              ...
              <a
                href="/pdf/19-STOU 20W 40 copy.pdf"
                download
              ...
              <table className="w-full text-left border-collapse bg-white text-sm min-w-[450px]">
                ...
                <tbody className="divide-y divide-gray-100 text-slate-600">
                  {[
                    ...
                    ['KV @ 40\u00b0C', 'ASTM D445', '118'],
                    ['KV @ 100\u00b0C', 'ASTM D445', '14.9'],
                    ['Viscosity Index', 'ASTM D2270', '130'],
                    ['Density @ 15\u00b0C', 'ASTM D4052', '0.8787'],
                    ['Flash Point', 'ASTM D97', '\u2265215'],
