...
export default function UniversalTractorTransmissionOil() {
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <Link href="#" className="hover:text-green-500 transition">AGRICULTURAL & OFF-HIGHWAY LUBRICANTS </Link>
                            <span>/</span>
                            <span className="text-green-400">UNIVERSAL TRACTOR TRANSMISSION OIL</span>
                        </nav>
                        ...
                        <span className="hidden md:inline-block inline-block bg-red-600 text-white text-xs font-bold uppercase tracking-widest px-3 py-1 rounded mb-4 shadow-lg">
                            High Performance AGRICULTURAL & OFF-HIGHWAY LUBRICANTS
                        </span>
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
                            Universal Tractor  <br/><span className="text-green-400">Transmission Oil</span>
                        </h1>
                        <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
                            Specially formulated for multi-purpose agricultural and off-highway machinery. Delivers exceptional wear protection, smooth hydraulic response, and superior thermal stability to protect transmissions, wet brakes, and hydraulic systems under heavy field loads
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                        ...
                        <main className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <Link href="/products/Agricultural-&-off-Highway-Lubrucants/universal-tractor-transmission-oil/sbk-universal-tractor-transmission-oil" className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <span className="absolute top-3 left-3 bg-orange-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Agricultural</span>
                                        <img src="/img/Drum-Red-(2).png" alt="SBK UTTO" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md"/>
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Transmission Oil</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-orange-600 transition tracking-tight mb-2 line-clamp-2">SBK UNIVERSAL TRACTOR TRANSMISSION OIL UTTO 10W-30</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Engineered for extreme field conditions, delivering robust wear protection, superior thermal stability, and smooth wet-brake performance to maximize heavy-duty equipment uptime.</p>
