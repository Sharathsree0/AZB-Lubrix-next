...
export default function WhiteOilTechnicalPage() {
    ...
    return (
        <div className="bg-white text-slate-700 antialiased">
            ...
            <section className="relative bg-cover bg-center bg-no-repeat text-white py-16 md:py-18 overflow-hidden w-full" 
                     style={{ backgroundImage: "url('/productbanner/white-oil-techinal.jpeg')" }}>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <span className="text-green-400">WHITE OIL TECHNICAL</span>
                        </nav>
                        ...
                        <span className="hidden md:inline-block inline-block bg-red-600 text-white text-xs font-bold uppercase tracking-widest px-3 py-1 rounded mb-4 shadow-lg">
                            High Performance WHITE OIL TECHNICAL
                        </span>
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
                            WHITE OIL <span className="text-green-400">TECHNICAL</span>
                        </h1>
                        <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
                            Engineered to deliver exceptional purity and stability, our high-performance white oils offer complete chemical inertness, excellent color retention, and non-staining performance.
                        </p>
                    </div>
                </div>
            </section>
                            ...
                            <div className="space-y-2 overflow-y-auto pr-2 custom-scrollbar flex-grow">
                                ...
                                <div className="category-accordion border border-gray-100 rounded-lg overflow-hidden active" data-locked="true">
                                    ...
                                    <div className="accordion-content bg-white border-t border-gray-50 px-2 py-2 space-y-1">
                                        <Link href="/Special-products/whiteoil" className="block text-xs font-bold text-red-600 bg-red-50/50 px-3 py-2 rounded transition"><i className="fas fa-caret-right mr-1.5"></i>SBK OMINI WHITE - LIGHT</Link>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <a href="#" onClick={openNoticeModal} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        ...
                                        <img src="/productimage/HDPE.png" alt="SBK OMINI WHITE - LIGHT" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">White Oil Technical</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">SBK OMINI WHITE - LIGHT</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Ultra-low viscosity technical white oil engineered for high-speed textile machinery and light plasticizers. Delivers rapid heat transfer, excellent color stability, and non-staining performance in precision processing.</p>
                                ...
                                <a href="#" onClick={openNoticeModal} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <span className="absolute top-3 left-3 bg-red-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Specialty Products</span>
                                        <img src="/productimage/HDPE.png" alt="SBK OMINI WHITE - MEDIUM" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">White Oil Technical</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">SBK OMINI WHITE - MEDIUM</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Versatile medium-viscosity technical mineral oil offering balanced lubrication and chemical inertness. Ideal for polymer processing, elastomer compounding, and general industrial formulations requiring high purity.</p>
                                        <div className="border-t border-gray-100 pt-4 mt-auto">
                                            <div className="w-full py-2 bg-slate-800 text-white text-xs font-bold rounded-lg flex justify-center items-center gap-1.5 group-hover:bg-red-600 transition-colors">
                                                Specifications <i className="fas fa-arrow-right"></i>
                                            </div>
                                ...
                                <a href="#" onClick={openNoticeModal} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <span className="absolute top-3 left-3 bg-red-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Specialty Products</span>
                                        <img src="/productimage/HDPE.png" alt="SBK OMINI WHITE - HEAVY" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">White Oil Technical</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">SBK OMINI WHITE - HEAVY</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">High-viscosity technical white oil featuring superior film strength and thermal resistance. Formulated for heavy rubber processing, adhesives, and demanding industrial applications under higher thermal loads.</p>
                                        <div className="border-t border-gray-100 pt-4 mt-auto">
                                            <div className="w-full py-2 bg-slate-800 text-white text-xs font-bold rounded-lg flex justify-center items-center gap-1.5 group-hover:bg-red-600 transition-colors">
                                                Specifications <i className="fas fa-arrow-right"></i>
                                            </div>
