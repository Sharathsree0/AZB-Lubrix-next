...
export default function TransformerOilPage() {
    ...
    return (
        <div className="bg-white text-slate-700 antialiased">
            ...
            <section className="relative bg-[#030712] text-white py-16 md:py-18 overflow-hidden w-full bg-cover bg-center bg-no-repeat" 
                     style={{ backgroundImage: "url('/productbanner/transformer.jpg')" }}>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <span className="text-green-400">TRANSFORMER OIL</span>
                        </nav>
                        ...
                        <span className="hidden md:inline-block inline-block bg-red-600 text-white text-xs font-bold uppercase tracking-widest px-3 py-1 rounded mb-4 shadow-lg">
                            High Performance TRANSFORMER OIL
                        </span>
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
                            TRANSFORMER <span className="text-green-400">OIL</span>
                        </h1>
                        <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
                            Engineered for the critical demands of electrical infrastructure, our specialty transformer oils provide superior dielectric insulation, exceptional chemical stability, and rapid heat dissipation.
                        </p>
                    </div>
                </div>
            </section>
                            ...
                            <div className="space-y-2 overflow-y-auto pr-2 custom-scrollbar flex-grow">
                                ...
                                <div className="category-accordion border border-gray-100 rounded-lg overflow-hidden active" data-locked="true">
                                    ...
                                    <div className="accordion-content bg-white border-t border-gray-50 px-2 py-2 space-y-1">
                                        <Link href="/Special-products/transformeroil" className="block text-xs font-bold text-red-600 bg-red-50/50 px-3 py-2 rounded transition"><i className="fas fa-caret-right mr-1.5"></i>SBK BS-148</Link>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <a href="#" onClick={openNoticeModal} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        ...
                                        <img src="/img/Drum-Red-(2).png" alt="SBK BS-148 Transformer Oil" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Transformer Oil</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">SBK BS-148 Transformer Oil</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">High-purity uninhibited insulating oil engineered for transformers and switchgears. Delivers exceptional dielectric strength, rapid heat dissipation, and high oxidation stability.</p>
                                ...
                                <a href="#" onClick={openNoticeModal} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <span className="absolute top-3 left-3 bg-red-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Specialty Products</span>
                                        <img src="/img/Drum-Red-(2).png" alt="SBK IEC 296 Transformer Oil" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Transformer Oil</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">SBK IEC 296 Transformer Oil</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Classic, field-proven mineral insulating oil meeting standard IEC requirements. Provides consistent dielectric protection, effective thermal cooling, and reliable performance in distribution transformers.</p>
                                        <div className="border-t border-gray-100 pt-4 mt-auto">
                                            <div className="w-full py-2 bg-slate-800 text-white text-xs font-bold rounded-lg flex justify-center items-center gap-1.5 group-hover:bg-red-600 transition-colors">
                                                Specifications <i className="fas fa-arrow-right"></i>
                                            </div>
                                ...
                                <a href="#" onClick={openNoticeModal} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <span className="absolute top-3 left-3 bg-red-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Specialty Products</span>
                                        <img src="/img/Drum-Red-(2).png" alt="SBK IEC 60296 UNINHIBITED" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Transformer Oil</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">SBK IEC 60296 UNINHIBITED</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Pure, high-grade mineral insulating oil completely free of antioxidant additives. Fully compliant with modern IEC 60296 global standards, ensuring excellent low-temperature fluidity and rapid heat transfer.</p>
                                        <div className="border-t border-gray-100 pt-4 mt-auto">
                                            <div className="w-full py-2 bg-slate-800 text-white text-xs font-bold rounded-lg flex justify-center items-center gap-1.5 group-hover:bg-red-600 transition-colors">
                                                Specifications <i className="fas fa-arrow-right"></i>
                                            </div>
                                ...
                                <a href="#" onClick={openNoticeModal} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        <span className="absolute top-3 left-3 bg-red-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Specialty Products</span>
                                        <img src="/img/Drum-Red-(2).png" alt="SBK IEC 60296 INHIBITED" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                                    </div>
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Transformer Oil</span>
                                        <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-red-600 transition tracking-tight mb-2 line-clamp-2">SBK IEC 60296 INHIBITED</h3>
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Premium insulating oil formulated with high-quality oxidation inhibitors. Developed to meet strict IEC 60296 specifications, actively preventing sludge formation for extended lifetime protection in high-load power grids.</p>
                                        <div className="border-t border-gray-100 pt-4 mt-auto">
                                            <div className="w-full py-2 bg-slate-800 text-white text-xs font-bold rounded-lg flex justify-center items-center gap-1.5 group-hover:bg-red-600 transition-colors">
                                                Specifications <i className="fas fa-arrow-right"></i>
                                            </div>
