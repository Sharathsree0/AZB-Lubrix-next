...
export default function FlushingOilPage() {
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/productbanner/flushingoil.jpeg')" }}
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <nav className="flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
              ...
              <span>/</span>
              <span className="text-green-400">Flushing Oil</span>
            </nav>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
              Flushing <span className="text-green-400">Oil</span>
            </h1>
            <p className="text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
              Discover our comprehensive range of specialized flushing oils. Engineered for peak performance, our fluids maximize equipment uptime, ensure superior system cleanliness, and prepare internal components for optimal thermal stability under the most demanding industrial operating conditions.
            </p>
          </div>
        </div>
      </section>
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">
                      Fast-acting industrial flushing fluid engineered to dissolve varnish, safely purge sludge and particulate debris, and prepare internal systems for fresh lubricant charges.
                    </p>
