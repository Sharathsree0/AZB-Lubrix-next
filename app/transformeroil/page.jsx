        ...
        accordions.forEach((acc) => {
            ...
            const clickHandler = function (e) {
                ...
                if (isCurrentlyActive) {
                    ...
                    toggleBtn.className = "accordion-toggle w-full flex justify-between items-center text-green-700 px-4 py-3 font-bold text-sm text-left transition-all";
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <Link href="/hydraulic-oil" className="hover:text-green-500 transition">SPECIALITY PRODUCTS </Link>
                            <span>/</span>
