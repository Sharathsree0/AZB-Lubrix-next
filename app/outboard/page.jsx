...
export default function OutboardPage() {
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/productbanner/outboard.jpeg')" }}
      >
          ...
          <div className="max-w-3xl">
            ...
            <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
              ...
              <span className="hover:text-green-500 transition cursor-default">
                Motorcycle Oil & Outboard Oils
              </span>
              <span>/</span>
              <span className="text-green-400">Outboard</span>
            </nav>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
              Outboard <span className="text-green-400"></span>
            </h1>
            <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
              Experience ultimate marine reliability with our premium Outboard oil.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
            ...
            <main className="lg:col-span-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Product 1: SBK OUTBOARD OIL TC-W3 */}
                <a href="#" onClick={handleCardClick} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                  <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                    <span className="absolute top-3 left-3 bg-blue-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">Outboard</span>
                    <img src="/productimage/5L-sbk-outboard-oil-tc-w3.png" alt="SBK Outboard Oil TC-W3" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                  </div>
                  <div className="p-5 flex flex-col flex-grow">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">Outboard Oil</span>
                    <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-green-600 transition tracking-tight mb-2 line-clamp-2">SBK OUTBOARD OIL TC-W3</h3>
                    <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">Formulated for water-cooled 2-stroke outboard marine engines, providing outstanding protection against saltwater corrosion, ring sticking, and spark plug fouling.</p>
                    <div className="border-t border-gray-100 pt-4 mt-auto">
                      <div className="w-full py-2 bg-slate-800 text-white text-xs font-bold rounded-lg flex justify-center items-center gap-1.5">Specifications <i className="fas fa-arrow-right text-[10px]"></i></div>
                    </div>
                  </div>
                </a>

                {/* Product 2: SBK 2T SAE 30 API TC */}
                <a href="#" onClick={handleCardClick} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                  <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                    <span className="absolute top-3 left-3 bg-green-600 text-white text-[10px] font-extrabold px-2 py-0.5 rounded shadow">2-Stroke</span>
                    <img src="/productimage/5L-sbk-2t-sae-30-api-tc.png" alt="SBK 2T SAE 30" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md" />
                  </div>
                  <div className="p-5 flex flex-col flex-grow">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 block">2T Engine Oil</span>
                    <h3 className="text-sm font-extrabold text-slate-800 group-hover:text-green-600 transition tracking-tight mb-2 line-clamp-2">SBK 2T SAE 30 API TC</h3>
                    <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">High-performance 2-stroke engine lubricant engineered for low-smoke combustion, preventing carbon deposits, piston scuffing, and wear in high-RPM operations.</p>
                    <div className="border-t border-gray-100 pt-4 mt-auto">
                      <div className="w-full py-2 bg-slate-800 text-white text-xs font-bold rounded-lg flex justify-center items-center gap-1.5">Specifications <i className="fas fa-arrow-right text-[10px]"></i></div>
                    </div>
                  </div>
