...
export default function TurbineOil() {
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <nav className="hidden md:flex items-center text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-200 mb-6 space-x-2">
                            ...
                            <span>/</span>
                            <span className="text-green-400">Turbine Oil</span>
                        </nav>
                        ...
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">
                            Turbine <span className="text-green-400">Oil</span>
                        </h1>
                        <p className="hidden md:block text-gray-100 text-base md:text-lg leading-relaxed drop-shadow-sm">
                           Discover our comprehensive range of high-performance turbine oils—engineered for exceptional oxidation resistance, rapid air release, and superior varnish control to ensure reliable power generation and continuous operation
                        </p>
                    </div>
                </div>
            </section>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <a href="#" onClick={(e) => handleCardClick(e, e.currentTarget)} className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 flex flex-col h-full block">
                                    ...
                                    <div className="relative bg-gradient-to-b from-gray-50 to-slate-100 p-6 flex justify-center items-center h-56 shrink-0">
                                        ...
                                        <img src="/img/Drum-Red-(2).png" alt="SBK Turbine Oil" className="h-44 object-contain group-hover:scale-105 transition duration-300 drop-shadow-md"/>
                                    </div>

                                    {/* Content Section */}
                                    <div className="p-5 flex flex-col flex-grow">
                                        <span className="text-[10px] font-bold text-green-600 uppercase tracking-wider mb-1 block">TURBINE LUBRICANT</span>
                                        ...
                                        <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-3 flex-grow">
                                            Premium industrial turbine oil engineered with high oxidation stability, excellent demulsibility, and rapid air release to prevent varnish formation and safeguard critical bearings.
                                        </p>
